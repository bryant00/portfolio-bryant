...
class About extends React.Component {
  ...
  render() {
    return (
      <BaseLayout title="Bryant Patton - Learn More About Me" {...this.props.auth}>
          ...
          <Row className="mt-5">
            ...
            <Col md="6">
              <div className="fadein">
                <p>My name is Bryant Patton and I am an experienced software engineer and freelance developer. </p>
                <p>
